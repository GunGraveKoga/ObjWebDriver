...
+(SEError*) errorWithCode:(ssize_t)code Message:(OFString*)message
{
    OFMutableDictionary *details = [OFMutableDictionary dictionary];
    [details setValue:message forKey:OFLocalizedDescriptionKey];
...
{
    return [SEError errorWithCode:[[dict objectForKey:@"status"] sSizeValue]];
}
