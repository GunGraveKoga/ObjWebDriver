...
-(OFString*) browserName { return [_dict objectForKey:BROWSER_NAME];}
-(void) setBrowserName:(OFString *)browserName { [_dict setValue:browserName forKey:BROWSER_NAME]; }

-(OFString*) version { return [_dict objectForKey:VERSION];}
-(void) setVersion:(OFString *)version { [_dict setValue:version forKey:VERSION]; }

-(OFString*) platform { return [_dict objectForKey:PLATFORM];}
-(void) setPlatform:(OFString *)platform { [_dict setValue:platform forKey:PLATFORM]; }
...
- (OFString *)app { return [_dict objectForKey:APP]; }
- (void)setApp:(OFString *)app { [_dict setObject:app forKey:APP]; }

- (OFString *)automationName { return [_dict objectForKey:AUTOMATION_NAME]; }
- (void)setAutomationName:(OFString *)automationName { [_dict setObject:automationName forKey:AUTOMATION_NAME]; }

- (OFString *)deviceName { return [_dict objectForKey:DEVICE_NAME]; }
- (void)setDeviceName:(OFString *)deviceName { [_dict setObject:deviceName forKey:DEVICE_NAME]; }

- (OFString *)platformName { return [_dict objectForKey:PLATFORM_NAME]; }
- (void)setPlatformName:(OFString *)platformName { [_dict setObject:platformName forKey:PLATFORM_NAME]; }

- (OFString *)platformVersion { return [_dict objectForKey:PLATFORM_VERSION]; }
- (void)setPlatformVersion:(OFString *)platformVersion { [_dict setObject:platformVersion forKey:PLATFORM_VERSION]; }

#pragma mark - Custom Capabilities

-(id) getCapabilityForKey:(OFString*)key { return [_dict valueForKey:key]; }
-(void) addCapabilityForKey:(OFString*)key andValue:(id)value { [_dict setValue:value forKey:key]; }
-(OFDictionary*) dictionary { return _dict; }
